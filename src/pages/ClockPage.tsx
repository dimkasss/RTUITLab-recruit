...
const ClockPage = () => {
  const [isClockChosen, setIsClockChosen] = useState(true);
    ...
    <>
      <div className="flex flex-wrap items-center  *:flex justify-center *:py-2 *:px-2 *:*:px-2">
        <Button.Group>
          ...
          <Button
            ...
            onClick={() => setIsClockChosen(false)}
          >
            Stopwatch
          </Button>
        </Button.Group>
      ...
      {isClockChosen ? (
        <div className="flex flex-col items-center justify-center *:my-5">
          ...
          />
          <div>
            {date.toLocaleString(isTwelveHourFormat ? "en-US" : "ru-RU", {
              day: "2-digit",
              month: "long",
              year: "numeric",
              weekday: "short",
